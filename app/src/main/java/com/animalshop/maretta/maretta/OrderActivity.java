package com.animalshop.maretta.maretta;
...
public class OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListMenu.add("Kandang Travel");
        mListMenu.add("Kandang Besar");
        mListMenu.add("One Set Package");
        mListMenu.add("Wol");
        mListMenu.add("Whiskas");
        mListMenu.add("Tempat Tidur Rajut");//memasukan info ke spinner
